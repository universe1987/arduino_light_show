...
PointShape heart_shape = PointShape(NUM_LEDS / 2);
...
int get_intrinsic_level(int i, float x, float y) {
...
void loop() {
  ...
  my_light.set_effect((LightEffect*)new FlameEffect(50, get_intrinsic_level), 30, 30);
}
